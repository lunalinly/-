(() => {
  ...
  function addField() {
    data.fields.push({ code: nextId("V", [...data.fields, ...data.variables].map(v => v.code)), label: "新欄位", category: "未分類", hint: "", type: "text", required: true, options: [], fillRules: [] });
  ...
  function addVariable() {
    ...
    const item = { code: nextId("V", [...data.fields, ...data.variables].map(v => v.code)), label: "新欄位", category: "未分類", hint: "", type: "text", required: true, options: [], fillRules: [] };
